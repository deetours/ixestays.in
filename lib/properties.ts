...
export const properties: Record<string, Property> = {
  "3bhk-villa": {
    ...
    heroImage: "/images/3bhk-villa.jpg",
    gallery: [
      { src: "/images/3bhk-villa.jpg", alt: "Villa living room" },
      { src: "/images/gallery-bedroom.jpg", alt: "Master bedroom" },
      { src: "/images/gallery-kitchen.jpg", alt: "Open kitchen" },
      { src: "/images/gallery-bathroom.jpg", alt: "Spa bathroom" },
      { src: "/images/lifestyle-balcony.jpg", alt: "Balcony view" },
      { src: "/images/lifestyle-evening.jpg", alt: "Evening ambiance" },
    ],
    price: 4500,
    maxGuests: 8,
    bedrooms: 3,
  ...
  "2bhk-retreat": {
    ...
    gallery: [
      ...
      { src: "/images/gallery-bedroom.jpg", alt: "Bedroom" },
      { src: "/images/gallery-kitchen.jpg", alt: "Kitchen" },
      { src: "/images/gallery-bathroom.jpg", alt: "Bathroom" },
      { src: "/images/lifestyle-workspace.jpg", alt: "Workspace" },
      { src: "/images/lifestyle-dining.jpg", alt: "Dining area" },
    ],
    price: 3000,
    maxGuests: 4,
    bedrooms: 2,
